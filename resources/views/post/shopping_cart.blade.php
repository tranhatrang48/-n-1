...
<head>
	...
	<title>BetaDesign Shopping Cart</title>
...
<body>
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="#"><img src="{{url('/image/asset/products/cart/1.png')}}" alt=""></a>
								...
								<div class="cart-item">
									...
									<a class="cart-item-delete" href="#"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="#"><img src="{{url('/image/asset/products/cart/2.png')}}" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Sample Woman Top</span>
											<span class="cart-item-options">Size: XS; Colar: Navy</span>
											<span class="cart-item-amount">1*<span>$49.50</span></span>
								...
								<div class="cart-item">
									...
									<a class="cart-item-delete" href="#"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="#"><img src="{{url('/image/asset/products/cart/3.png')}}" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Sample Woman Top</span>
											<span class="cart-item-options">Size: XS; Colar: Navy</span>
											<span class="cart-item-amount">1*<span>$49.50</span></span>
								...
								<div class="cart-caption">
									...
									<div class="center">
										<div class="space10">&nbsp;</div>
										<a href="/checkout" class="beta-btn primary text-center">Checkout <i class="fa fa-chevron-right"></i></a>
									</div>
								</div>
							</div>
						</div> <!-- .cart -->
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="/home">Shop</a>
							<ul class="sub-menu">
								<li><a href="/home">Home Shop 1</a></li>
								<li><a href="home_2.html">Home Shop 2</a></li>
								<li><a href="home_3.html">Home Shop 3</a></li>
					...
					<tbody>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="{{url('/image/asset/shoping1.jpg')}}" alt="">
									<div class="media-body">
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="{{url('/image/asset/shoping2.jpg')}}" alt="">
									<div class="media-body">
										<p class="font-large table-title">Men’s Belt</p>
										<p class="table-option">Color: Red</p>
										<p class="table-option">Size: M</p>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="{{url('/image/asset/shoping3.jpg')}}" alt="">
									<div class="media-body">
										<p class="font-large table-title">Men’s Belt</p>
										<p class="table-option">Color: Red</p>
										<p class="table-option">Size: M</p>
	...
	<div class="copyright">
		<div class="container">
            ...
            <a href="#"><img src="{{url('/image/asset/pay/master.jpg')}}" alt="" /></a>
				<a href="#"><img src="{{url('/image/asset/pay/pay.jpg')}}" alt="" /></a>
				<a href="#"><img src="{{url('/image/asset/pay/visa.jpg')}}" alt="" /></a>
				<a href="#"><img src="{{url('/image/asset/pay/paypal.jpg')}}" alt="" /></a>
			</p>
			<div class="clearfix"></div>
		</div> <!-- .container -->
	</div> <!-- .copyright -->
