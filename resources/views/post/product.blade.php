		...
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-sm-4">
						<img src="{{url('/image/product/'.$sanpham->image)}}" alt="" height="300px">
						</div>
						<div class="col-sm-8">
							<div class="single-item-body">
							<h3 class="single-item-title">{{$sanpham->name}}</h3>
								<p class="single-item-price">
								<span>{{$sanpham->unit_price-$sanpham->promotion_price}}</span>
								</p>
							</div>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									@endif
									<div class="single-item-header">
									<a href="/product/{{$cungloai->id}}"><img src="{{url('/image/product/'.$cungloai->image)}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">
									<p class="single-item-title">{{$cungloai->name}}</p>
										<p class="single-item-price">
										<span class="flash-del">{{$cungloai->unit_price}}</span>
											<span class="flash-sale">{{$cungloai->unit_price}}</span>
										</p>
									</div>
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="{{route('themgiohang',$cungloai->id)}}"><i class="fa fa-shopping-cart"></i></a>
									<a class="beta-btn primary" href="/product/{{$cungloai->id}}">Details <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
